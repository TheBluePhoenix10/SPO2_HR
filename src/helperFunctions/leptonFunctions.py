...
def raw_to_8bit(data):
    ...
    global maxVal
    global minVal
    cv2.normalize(data, data, (minVal-30315)*(65526/500), (maxVal-30315)*(65526/500), cv2.NORM_MINMAX)
...
def grabTempValue():
        ...
        try:
            ...
            dataArray1d= dataArray2d.flatten()
            meanTemp=np.mean(dataArray1d)
        except:
            meanTemp=0
        return  [ktof(meanTemp),ktof(minVal),ktof(maxVal)]#   meanTemp


def ktof(val):
    return round(((1.8 * ktoc(val) + 32.0)), 2)+2
